...
file_path = "C:/Users/Usuario/Documents/Visual Studio Code/dashboard/twitch_data/top_games_from_past_week_copy.csv"
...
if number_of_entries % 8 == 0:
    ...
    columns = ["Nome", "Top 1", "Frequência no Top 1", "Top 3", "Frequência no Top 3", "Top 8", "Frequênicia no Top 8", "Visualização Média", "Pico de Visualizações"]
