...
if number_of_entries % 8 == 0:
    ...
    names_top_1 = list(map(lambda x : x["Nome"], ranking[0])) #lista com todos os primeiros colocados
    top_3 = ranking[0] + ranking[1] + ranking[2] 
    names_top_3 = list(map(lambda x : x["Nome"], top_3)) #lista com todos os top 3
